...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12" style="margin-bottom: 20px;">
            <div class="row">
                <form method="post" action="/admin/reviews/create" class="horizontal-form">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Имя Фамилия" name="username" value="">
                    </div>
                    <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Ссылка на страницу пользователя"
                               name="user_link" value="">
                    </div>
                    <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Ссылка на аватар пользователя"
                               name="user_avatar" value="">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Ссылка на оригинал отзыва"
                               name="opinion_link" value="">
                    </div>
            </div>
            <div class="row">
                <div class="col-md-10"></div>
                <div class="col-md-2">
                    <button type="submit" class="btn blue"><i class="fa fa-check"></i> Добавить отзыв</button>
                </div>
            </div>
        </div>
        <div class="col-md-12">
