...
<form method="post" action="/admin/user/create" class="horizontal-form" id="save">
    <div class="modal-body">
        <div class="row">
            <div class="col-md-12">
                <a href="https://vk.com/{{ $user->login }}" target="_blank"><img
                        style="width: 150px;margin: 0 auto;border-radius: 50% !important;display: block;margin-bottom: 15px;"
                        src="{{ $user->avatar }}"/></a>
            </div>
        </div>
        ...
        <div class="form-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" tabindex="1" name="role" value="{{ $user->role }}">
                            ...
                            <option value="12"
                                    @if($user->role == 12) selected @endif>{{ trans('Administrator') }}</option>
                        ...
                        <select class="form-control" tabindex="1" name="manager_id">
                            ...
                            @foreach($managers as $manager)
                                <option value="{{  $manager->id }}"
                                        @if($user->manager_id == $manager->id) selected @endif>{{  $manager->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="bonus_money" value="{{ $user->bonus_money }}"
                               onchange="if (this.value < 0) this.value=0">
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="opened" value="{{ $user->opened }}"
                               onchange="if (this.value < 0) this.value=0">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="deposit" value="{{ $user->deposit }}"
                               onchange="if (this.value < 0) this.value=0">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="" class="control-label">Забанить до:</label>
                        <input type="text" name="banned_to" value="{{$user->banned_to}}"
                               class="form-control datetimepicker"/>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="" class="control-label">Забанить навсегда:</label>
                        <input type="checkbox" name="is_permanent_banned" value="1"
                               {{ ($user->is_permanent_banned === 1 ? ' checked' : '') }}
                               class="form-control datetimepicker"/>
                    </div>
                </div>
            </div>
