		...
		<div class="HelpLg__wrapper container">
			...
			<div class="HelpLg__button-row row">
				<div class="Help__button-col col-md-4 col-sm-6 col-xs-12">
					<a href="mailto:info@cryptocube.ru" target="_blank">
						<div class="HelpButton">
							<div class="HelpButton__img-wrapper"> <img class="HelpButton__img" src="/img/system/1.png" alt="info@cryptocube.ru"> </div>
							<div class="HelpButton__text">
								<div class="HelpButton__title"> {{ __('For any questions') }} </div>
								<div class="HelpButton__link-wrapper"> <span class="HelpButton__link"> info@cryptocube.ru </span>
								</div>
							</div>
						</div>
					</a>
				...
				<div class="Help__button-col col-md-4 col-sm-6 col-xs-12">
					...
					<a href="#" class="modal-toggle" data-toggle="login" data-title="{{ trans('Log in') }} &lt;span&gt;{{ trans('to the site') }}&lt;/span&gt;">
						<div class="HelpButton">
							<div class="HelpButton__img-wrapper"> <img class="HelpButton__img" src="/img/system/2.png" alt="info@cryptocube.ru"> </div>
							<div class="HelpButton__text">
				...
				<div class="Help__button-col col-md-4 col-sm-6 col-xs-12">
					<a href="mailto:reklama@cryptocube.ru" target="_blank">
						<div class="HelpButton">
							<div class="HelpButton__img-wrapper"> <img class="HelpButton__img" src="/img/system/3.png" alt=" reklama@cryptocube.ru"> </div>
							<div class="HelpButton__text">
								<div class="HelpButton__title"> {{ __('Advertising Suggestions') }} </div>
								<div class="HelpButton__link-wrapper"> <span class="HelpButton__link">  reklama@cryptocube.ru </span>
								</div>
							</div>
						</div>
					</a>
