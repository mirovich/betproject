...
<div class="header-menu">
    ...
    <div class="header-menu__close-button">
        ...
        <img src="/img/close-mobile-menu-hover.svg" alt=""
             class="header-menu__close-button-img header-menu__close-button-img_hover">
    </div>
    ...
    @if(Auth::guest())
        <div class="header-menu__link-line">
            <a href="#" class="modal-toggle header-menu__close2-button" data-toggle="login"
    ...
    <div class="header-menu__link-line">
        <a href="/tournaments">
            <div class="header-menu__link @yield('tournaments')">Турниры</div>
        </a>
    </div>
    <div class="header-menu__link-line">
        <a href="/faq">
    ...
    <div class="header-menu__link-line">
        @if (defined('TICKETS'))
            <a href="/tickets">
                <div class="header-menu__link @yield('help')"><span
                        class="circle">{{ TICKETS }}</span>{{ trans('Help') }}</a></div>
    @else
        <a href="/help">
            <div class="header-menu__link @yield('help')">{{ trans('Help') }}</div>
        </a>
    @endif
</div>
