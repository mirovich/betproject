...
@section('wdsystems')
    <div class="modal-window__pay-system pay-system modal-window__pay-system_center">
        <div
            class="modal-window__img-wrapper_main modal-window__img-wrapper modal-window__img-wrapper_big pay-system__img-wrapper is_payout"
            data-currency="1" data-provider="3" style="background-image:url(/img/system/mc_i.png)">
        </div>
        <div
            class="modal-window__img-wrapper_main modal-window__img-wrapper pay-system__img-wrapper_big pay-system__img-wrapper is_payout"
...
<div id="add-cash" class="modal-window modal-window_size_m modal-window_color_default">
    <div class="modal-window__wrapper">
        ...
        <div class="modal-window__content-wrapper">
            ...
            <div class="modal-window__element-header text-block text-block_tf_up text-block_align_center">
                {{ trans('Choose a replenishment method') }}:
            </div>
                ...
                <div class="modal-window__amount_purse hidden">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div
                                class="modal-window__element-header text-block text-block_tf_up text-block_align_center">
                                {{ trans('Enter amount') }}:
                            </div>
                            <div
                                class="modal-window__element modal-window__input-block modal-window__element_with-header">
                                <div class="input-block modal-window__input-wrapper">
                                    <input class="input-block__input payment-amount"
                                           title="{{ trans('Payout amount') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
